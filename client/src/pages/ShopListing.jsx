...
import { CircularProgress, Slider, TextField } from "@mui/material"; // Import TextField from MUI
...
const ShopListing = () => {
  ...
  const filteredProducts = products.filter((product) =>
    product.name.toLowerCase().includes(searchTerm.toLowerCase()) // Filtering products by search term
  );
